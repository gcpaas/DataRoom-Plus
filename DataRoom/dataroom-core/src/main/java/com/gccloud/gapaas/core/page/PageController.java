package com.gccloud.gapaas.core.page;
...
import com.gccloud.gapaas.core.entity.PageStageEntity;
import com.gccloud.gapaas.core.page.dto.PageOfflineDto;
import com.gccloud.gapaas.core.page.dto.PagePublishDto;
import com.gccloud.gapaas.core.page.dto.PageStageSearchDto;
import com.gccloud.gapaas.core.page.service.PageDesignService;
import com.gccloud.gapaas.core.page.service.PageReleaseService;
import com.gccloud.gapaas.core.page.service.PageStageService;
...
public class PageController extends SuperController {
     ...
     */
    @GetMapping("/list")
    public Resp<List<PageDesignEntity>> list(@RequestParam(name = "name") String name) {
        LambdaQueryWrapper<PageDesignEntity> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.select(PageDesignEntity::getId, PageDesignEntity::getPageType, PageDesignEntity::getName, PageDesignEntity::getRemark, PageDesignEntity::getState, PageDesignEntity::getUpdateDate);
        queryWrapper.orderByDesc(PageDesignEntity::getUpdateDate);
        if (StringUtils.isNotBlank(name)) {
            queryWrapper.like(PageDesignEntity::getName, name);
        }
        List<PageDesignEntity> list = pageDesignService.list(queryWrapper);
    ...
    public Resp<PageDesignEntity> detail(@PathVariable("id") String id) {
        PageDesignEntity pageDesignEntity = pageDesignService.getById(id);
     ...
     */
    @PostMapping("/insert")
    public Resp<String> insert(@RequestBody PageDesignEntity pageDesignEntity) {
     ...
     */
    @PostMapping("/update")
    public Resp<String> update(@RequestBody PageDesignEntity pageDesignEntity) {
    ...
    public Resp<String> publish(@RequestBody PagePublishDto pagePublishDto) throws JsonProcessingException {
        // 修改发布状态
        LambdaUpdateWrapper<PageDesignEntity> updateWrapper = new LambdaUpdateWrapper<PageDesignEntity>()
                .set(PageDesignEntity::getState, MaxvConstant.PageDesign.STATE.PUBLISHED)
                .set(PageDesignEntity::getUpdateDate, new Date())
                .eq(PageDesignEntity::getCode, pagePublishDto.getCode());
        ...
        // 更新发布记录
        PageDesignEntity pageDesignEntity = pageDesignService.getByCode(pagePublishDto.getCode());
    ...
    public Resp<Void> offline(@RequestBody PageOfflineDto pageOfflineDto) throws JsonProcessingException {
        LambdaUpdateWrapper<PageDesignEntity> updateWrapper = new LambdaUpdateWrapper<PageDesignEntity>()
                .set(PageDesignEntity::getState, MaxvConstant.PageDesign.STATE.DESIGN)
                .set(PageDesignEntity::getUpdateDate, new Date())
                .eq(PageDesignEntity::getCode, pageOfflineDto.getCode());
        pageDesignService.update(updateWrapper);
        // 发布到release表中
    ...
    public Resp<Void> delete(@PathVariable("code") String code) {
        ...
        LambdaQueryWrapper<PageDesignEntity> deleteDesignWrapper = new LambdaQueryWrapper<>();
        deleteDesignWrapper.eq(PageDesignEntity::getCode, code);
    ...
    public Resp<Void> updatePageConfig(@RequestBody PageDesignEntity pageDefinition) {
        LambdaUpdateWrapper<PageDesignEntity> updateWrapper = new LambdaUpdateWrapper<>();
        updateWrapper.set(PageDesignEntity::getPageConfig, pageDefinition.getPageConfig());
        updateWrapper.eq(PageDesignEntity::getId, pageDefinition.getId());
        updateWrapper.set(PageDesignEntity::getUpdateDate, new Date());
        updateWrapper.set(PageDesignEntity::getName, pageDefinition.getName());
        pageDesignService.update(updateWrapper);
        return Resp.success(null);
    }
    ...
    public Resp<String> stageRollback(@PathVariable("id") String id) throws JsonProcessingException {
        ...
        PageDesignEntity pageDesignEntity = pageDesignService.getByCode(pageStageEntity.getCode());
        // 当前设计态转为历史记录
        ...
        // 回退历史为当前设计态
        PageDesignEntity rollbackPageDesignEntity = null;
        ...
        if (MaxvConstant.PageStage.TARGET.PAGE_RELEASE.equals(stateTarget)) {
            ...
            rollbackPageDesignEntity = objectMapper.readValue(pageStageEntity.getEntityConfig(), PageDesignEntity.class);
        }
        // 覆盖回退
